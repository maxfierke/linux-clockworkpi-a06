...
source=("http://www.kernel.org/pub/linux/kernel/v5.x/${_srcname}.tar.xz"
        ...
        '0024-mmc-meson-gx-do-not-use-memcpy_to-fromio-for-dram-access-quirk.patch'
...
md5sums=('a082ef5748b813abca0649dab8be5f52'
         '1a85cb58d1b2fa247feaaf1802138a09'
         ...
         'd5a13bbe2761b5e5637081481a2ac6a6'
...
prepare() {
  ...
  patch -Np1 -i "${srcdir}/0024-mmc-meson-gx-do-not-use-memcpy_to-fromio-for-dram-access-quirk.patch"   #Radxa Zero
